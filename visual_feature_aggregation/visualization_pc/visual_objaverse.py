...
# from _shapenet import ShapenetLoader
from _objaverse import ObjaverseLoader


def main(
    data_path: Path = Path("/home/jiangyun/documents/Sp2Sl/data/render_outputs/objaverse/renders/0a0a8274693445a6b533dce7f97f747c"),
    ...
    # loader = ShapenetLoader(data_path, num_frames=20)
    loader = ObjaverseLoader(data_path)
    ...
    for i in tqdm(range(num_frames)):
        ...
        # pc_path = "/home/jiangyun/documents/GaussianCube/output.ply"

        # pc = o3d.io.read_point_cloud(pc_path)
        # position, color = np.asarray(pc.points), np.asarray(pc.colors)
